<nav class="ts-sidebar">
			<ul class="ts-sidebar-menu">
				...
				{ ?>
					...
					<li><a href="#"><i class="fa fa-file-o"></i> Complaints</a>
					<ul>
						<li><a href="complaint.php">Register Complaint</a></li>
						<li><a href="complaint-details.php">Manage Complaints</a></li>
					</ul>
					<li><a href="notices.php"><i class="fa fa-file-o"></i>Notices</a></li>
				<?php } 
				else { ?>
