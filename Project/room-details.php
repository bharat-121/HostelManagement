...
$uid=$_SESSION['login'];
				...
				<?php }
					...
					$roomalreadybooked=0;
					?>
					<marquee><h1 style="color: lime">No Room has been booked by you yet.</h1></marquee>
						<?php	}			
							?>
<?php	

if($roomalreadybooked==1)
{
	?>
	<?php
		$aid=$_SESSION['login'];
		...
		<td><a href="javascript:void(0);"  onClick="popUpWindow('http://localhost/HostelManagementProject/full-profile.php?id=<?php echo $row->emailid;?>');" title="View Full Details">Print Data</a></td>
		</tr>
		<tr>
