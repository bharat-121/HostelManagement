...
<?php 
		 $ret= $mysqli->query("SELECT * FROM registration where emailid = '".$_GET['id']."'");
			...
			<tr>
			  <td colspan="2"  class="font"><b><?php echo ucfirst($row['firstName']);?> <?php echo ucfirst($row['lastName']);?>'s </b><span class="font1"> information &raquo;</span> </td>
  </tr>
			<tr>
